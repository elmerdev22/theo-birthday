            ...
            <div class="row justify-content-center mb-5">
                ...
                <div class="col-lg-8 col-md-10 col-12">
                    <div class="input-group input-group-lg">
                        <input style="border-radius: 0;" type="text" class="form-control py-3 form-control bg-light" placeholder="Enter your name" aria-label="Input group example" aria-describedby="btnGroupAddon">
                        <div class="input-group-append" id="btnGroupAddon">
                            <button style="border-radius: 0;" class="btn btn-primary btn-lg py-3">Submit</button>
                        </div>
                    </div>
                </div>
            </div>
